...
**Goal:** Replace the current left-copy/right-image Hero with the approved full-screen photographic Mac composition, real expanded/collapsed Pome Panel interaction, and staged entrance animation.
