# Pome Panel · 仪表盘设计规格（DASHBOARD-DESIGN）
...
notch-home-note        // 速记原始 Markdown 文本
...
- 首页速记升级为安全的 Markdown 编辑/预览，支持标题、粗斜体、列表、任务列表、引用、代码和 http/https 链接；原始文本仍存 `notch-home-note`。
