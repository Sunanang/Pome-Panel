export const LATEST_RELEASE_API_URL = "https://api.github.com/repos/Sunanang/Pome-Panel/releases/latest";
...
export function selectWindowsDownloadUrl(release) {
  ...
  const name = `Pome-Panel-${release.tag_name.replace(/^v/, '')}-windows-x64-setup.exe`;
...
export function selectMacDownloadUrl(release) {
  ...
  const expectedAssetName = releaseVersion
    ? `Pome-Panel-${releaseVersion}-arm64.dmg`
    : "";
