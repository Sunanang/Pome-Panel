<div align="center">
  ...
  <p>
    <a href="https://github.com/Sunanang/Pome-Panel/releases/latest"><strong>下载 macOS 版</strong></a>
    ·
    <a href="https://github.com/Sunanang/Pome-Panel/releases/latest"><strong>下载 Windows 版</strong></a>
    ·
  ...
  <p>
    <img alt="Release" src="https://img.shields.io/github/v/release/Sunanang/Pome-Panel?style=flat-square&color=7c8cff" />
...
Pome Panel 是一个常驻 macOS / Windows 屏幕顶部的本地工作台。Mac 默认折叠成物理刘海大小；Windows 显示为贴顶的 200 × 38 逻辑像素悬浮条，避开顶部任务栏。点击后从顶部展开。
...
| --- | --- |
| Mac | [Pome-Panel-1.1.2-arm64.dmg](https://github.com/Sunanang/Pome-Panel/releases/download/v1.1.2/Pome-Panel-1.1.2-arm64.dmg) |
| Windows | [Pome-Panel-1.1.2-windows-x64-setup.exe](https://github.com/Sunanang/Pome-Panel/releases/download/v1.1.2/Pome-Panel-1.1.2-windows-x64-setup.exe) |

### macOS

1. 前往 [GitHub Releases](https://github.com/Sunanang/Pome-Panel/releases/latest) 下载 `Pome-Panel-*-arm64.dmg`。
2. 打开 DMG，将 `Pome Panel.app` 拖入「应用程序」。
...
下载 `Pome-Panel-*-windows-x64-setup.exe`，运行安装向导，再从桌面或开始菜单启动。默认仅安装给当前用户，无需管理员权限，卸载保留本机工作区数据。托盘菜单可设置功能或退出，面板设置中可开启开机启动。
...
Pome Panel 只在 `127.0.0.1:43821` 监听通知接口，来源限 `codex`、`claude` 与 `gpt`：
...
```text
/Applications/Pome Panel.app/Contents/Resources/app/scripts/codex-notify.js
/Applications/Pome Panel.app/Contents/Resources/app/scripts/claude-notify.js
```
